...
namespace Library_management
{
    public partial class BookUser : Form
    {
        ...
        public BookUser(string username, string userid, string bookname, string bookcode)
        {
            InitializeComponent();
            ...
            {
                comboBox1.Items.Add($"{user.Username} {user.id}");
            }
            ...
            comboBox1.SelectedItem = $"{username} {userid}";
            comboBox2.SelectedItem = $"{bookname} {bookcode}";
